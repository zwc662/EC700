...
/*	if*/
/*	::elv?close,_ -> mov= true;*/
/*	::elv?open,_ -> mov = false;*/
/*	fi*/
/*}*/

/*ltl p1{ [] !(mov == true && doors_open == true)}*/
/*ltl p2{ [] (((iam[0]==1 || iam[1]==1) && floor != 1) -> (<> (floor==1 && (iam[0]==1 || iam[1]==1))))}*/
ltl p3{[]((<> (floor == 0)) && (<> (floor == 1)) && (<> (floor == 2)) && (<> (floor == 3)))}
/*ltl p{[](<> (floor==0))}*/
